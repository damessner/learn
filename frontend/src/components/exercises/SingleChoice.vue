<template>
  <div class="exercise-card sc-exercise">
    <div class="exercise-header">
      <span class="exercise-badge">Single Choice</span>
...
const props = defineProps({
  ...
  correctAnswer: Number, // correct option index from backend feedback
  points: Number,
  instruction: {
    type: String,
...
const selectedIdx = ref(props.modelValue !== undefined ? props.modelValue : null)
...
const isSelected = (idx) => selectedIdx.value === idx

const isCorrectOption = (idx) => {
  return props.correctAnswer !== undefined && props.correctAnswer === idx
}
